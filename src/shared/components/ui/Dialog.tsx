...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-button p-1.5 text-muted-foreground opacity-80 transition-colors hover:bg-surface-warm hover:text-brand-navy hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-brand-orange-accessible disabled:pointer-events-none">
        <X className="h-4 w-4" />
