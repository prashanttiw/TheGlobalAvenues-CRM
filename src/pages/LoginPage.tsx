...
import { User, Briefcase, ArrowRight, Lock, Mail, MessageSquare, Eye, EyeOff, RefreshCw } from 'lucide-react';
      ...
      <div className="max-w-md w-full px-6 py-12 relative z-10">
        ...
        >
          <div className="flex justify-center mb-6">
            <motion.div
              className="w-12 h-12 rounded-xl border border-[#FD7E14]/15 bg-[#FFF8F1] flex items-center justify-center shadow-lg"
              layout
            >
              <img
